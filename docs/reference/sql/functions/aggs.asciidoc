...
---------------------------------------
More over it cannot be used on top of literals:
[source, sql]
---------------------------------------
 SELECT KURTOSIS(10.123), gender FROM emp GROUP BY gender
---------------------------------------
====
...
[source, sql]
---------------------------------------
 SELECT SKEWNESS(10.123), gender FROM emp GROUP BY gender
---------------------------------------
====
